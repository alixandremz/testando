...
def iniciar_tabelas():
    ...
    codigos_acesso = [
        ("MOD-CRATO-483920",   "moderador", None),
        ("MOD-CRATO-715064",   "moderador", None),
        ("SERV-DETRAN-239871",  "servidor",  "DETRAN"),
        ("SERV-SAMU-906152",    "servidor",  "SAMU"),
        ("SERV-BOMB-554738",    "servidor",  "Corpo de Bombeiros"),
        ("SERV-SAUDE-128693",   "servidor",  "Secretaria de Saúde")
    ]
